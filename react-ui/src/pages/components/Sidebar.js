        ...
        return (
			<nav id="sidebar" style={{fontSize: '12px', marginTop: '75px'}}>
				<ul className="list-unstyled Tsidebar">
					...
					<li><Link to="/tasktemplate"> <img src={template} style={{'height':'20px'}}/> &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Task Templates</Link></li>
					<li><Link to="/clients"> <i className="fa fa-users" style={{'color':'#95C53D'}}></i>Clients </Link></li>
					<li><Link to="/users"> <img src={users} style={{'height':'30px','float': 'left', 'marginLeft': '-10px'}}/> &nbsp;&nbsp;| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Users </Link></li>
				</ul>
			</nav>
    	);
    }
